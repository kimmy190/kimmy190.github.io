...
Developer who genunienly cares about solving problems and make life more easier. Likes to show my creativity through arts.
...
Honours Bachelor of Science - Computer Science Specialist                   University of Toronto
University of Toronto International Scholar Award

# Skills 

Programming Languages: C/C++, Python, Javascript, Typescript, HTML5, CSS, PostgreSQL, MySQL, Java, Assembly, R
Tools/Frameworks: React, Node.js, Next.js, Django, Tailwind, Bootstrap, jQuery, Prisma, Quarto, Git, Github, Postman, SpringBoot, Figma, RStudio,Tableau, NumPy, Flask, pandas, seaborn, Matplotlib, BeautifulSoup, scikit-learn, Lighthouse

# Experience 

## Freelance Full-Stack Developer                                                                         June 2026 – Present  
...
• Handled 3000+ daily database queries and structured error handling by designing robust CRUD-based REST API using Flask
• Built client-side search, filtering, and sorting with React, letting interpreters browse 2,000+ entries instantly without reloading a page
...
• Resolved persistent cross-device scroll alignment defects by systematically debugging browser snap-scroll behavior and keyboard event handling, replacing with a deterministic navigation system
...
## Diabetes Data Visualization     Nov 2024 – Dec 2024
...
- Cleaned and altered raw datasets with R, handling missing values, standardizing formats, and restructuring fields

## Automated Job Search Agent           April 2026 - May 2026

- Built an automatic Python pipeline using Claude API to scrape LinkedIn job postings and score fit against a personal resume profile
- Designed a custom AI scoring rubric to rank opportunities and push filtered results to Google Sheets via REST API
  Junior software engineer with experience in building and deploying full-stack web apps and REST APIs.
